public class Series<T> {
     ...
     public Series(String[] _rowNames, T[] _data) {
          ...
          for (int i = 0; i < _data.length; i++) { // deep copy of data
               this.data[i] = _data[i];
          }
     ...
     public String[] getData() {
          ...
          for (int i = 0; i < this.data.length; i++) {
               dataStrings[i] = this.data[i].toString(); // convert T type elements to string
          }
          return dataStrings;
     }
     ...
     public void append(String rn, T d) {
          ...
          T[] newData = (T[]) new Object[oldLength + 1];
          ...
          if (rn == null || rn.isEmpty()) {
               defaultRowName = Integer.toString(oldLength); // default to index number
     ...
     public boolean drop(String rn) throws NullPointerException, IllegalArgumentException {
          ...
          T[] newData = (T[]) new Object[this.data.length - 1];
          int newIndex = 0;
